      ...
      <div class="container-fluid">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="home_Librarian.php">Library Management System</a>
          </div>
          ...
          <table cellpadding="0" cellspacing="0" border="0">
            <tbody>
              <?php
                ...
                //$userid = '1';
                if ($_SESSION['userid'] != '') $userid = substr($_SESSION['userid'], 3,1);                $query = 'SELECT * FROM bookrecords'; 
                ...
                if($result->num_rows > 0)
                {
                  ...
                  {
                    echo "<tr><td>" . $row['bookid'] ."</td><td>" .$row['ID'].
                         "</td><td>". $row['issuedate'] ."</td><td>" .$row['duedate'].
                         //"</td><td>". $row['bookid']  ."</td><td>".$row['NumOfCopies'].
                         "</td></tr>";
                  }
                }  
              ?>
